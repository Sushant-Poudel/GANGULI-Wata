      ...
      <main className="pt-20 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="font-heading text-4xl font-bold text-white uppercase tracking-tight mb-3">
              Blog & <span className="text-gold-500">Guides</span>
            </h1>
            ...
            <div className="space-y-4">
              {posts.map((post) => (
                <Link
                  key={post.id}
                  to={`/blog/${post.slug}`}
                  className="block bg-card border border-white/10 rounded-lg p-5 hover:border-gold-500/50 transition-all duration-300 group"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 className="font-heading text-xl font-semibold text-white group-hover:text-gold-500 transition-colors">
                        {post.title}
                      </h2>
