    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <div className="pt-20 pb-12 max-w-3xl mx-auto px-4">
          ...
          <div className="h-12 w-full skeleton rounded mb-6"></div>
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="pt-20 pb-12">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link to="/blog" className="inline-flex items-center text-white/60 hover:text-gold-500 mb-6 transition-colors">
          ...
          <div 
            className="prose prose-invert prose-gold max-w-none rich-text-content"
