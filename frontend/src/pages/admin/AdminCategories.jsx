...
export default function AdminCategories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Error saving category');
    }
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
          {isLoading ? (
            ...
            categories.map((category) => (
              <div
                key={category.id}
                className="bg-card border border-white/10 rounded-lg p-4 hover:border-gold-500/30 transition-all flex items-center justify-between"
              ...
              >
                <div>
                  ...
                  <p className="text-white/40 text-xs">slug: {category.slug}</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Gaming, OTT Subscriptions, Software"
                  required
