...
import { LayoutDashboard, Package, FolderOpen, Star, FileText, Share2, LogOut, Home, Menu, X, HelpCircle, Store, Bell, BookOpen, CreditCard, Ticket, Settings, Send, Gift } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/admin/bundles', label: 'Bundle Deals', icon: Gift },
